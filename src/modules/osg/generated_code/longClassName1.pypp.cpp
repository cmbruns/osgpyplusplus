...
void register_longClassName1_class(){
    ...
    { //::std::map< std::pair<osg::StateAttribute::Type, unsigned int>, std::pair<osg::ref_ptr<osg::StateAttribute>, unsigned int> >
        ...
        longClassName1_exposer.def( bp::indexing::map_suite< std::map< std::pair<osg::StateAttribute::Type, unsigned int>, std::pair<osg::ref_ptr<osg::StateAttribute>, unsigned int> > >() );
    }
