...
void register_TransformCallback_class(){
    ...
    bp::class_< TransformCallback_wrapper, bp::bases< ::osg::NodeCallback >, osg::ref_ptr< TransformCallback_wrapper >, boost::noncopyable >( "TransformCallback", "\n TransformCallback is now deprecated, use osg::AnimationPathCallback instead.\n", bp::init< osg::Vec3 const &, osg::Vec3 const &, float >(( bp::arg("pivot"), bp::arg("axis"), bp::arg("angularVelocity") ), "\n TransformCallback is now deprecated, use osg::AnimationPathCallback instead.\n") )    
        .def( 
            "__call__"
